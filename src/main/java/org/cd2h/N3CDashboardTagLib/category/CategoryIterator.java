...
public class CategoryIterator extends N3CDashboardTagLibBodyTagSupport {
	...
	public static String categoryCount() throws JspTagException {
		int count = 0;
		CategoryIterator theIterator = new CategoryIterator();
		try {
			PreparedStatement stat = theIterator.getConnection().prepareStatement("SELECT count(*) from n3c_dashboard.category"
						);
			...
			log.error("JDBC error generating Category iterator", e);
			throw new JspTagException("Error: JDBC error generating Category iterator");
		} finally {
    ...
    public int doStartTag() throws JspException {
      ...
      try {
            ...
            log.error("JDBC error generating Category iterator: " + stat, e);
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: JDBC error generating Category iterator: " + stat);
				return parent.doEndTag();
			}else{
				throw new JspException("Error: JDBC error generating Category iterator: " + stat,e);
			}
    ...
    private String generateFromClause() {
       StringBuffer theBuffer = new StringBuffer("n3c_dashboard.category");
    ...
    public int doAfterBody() throws JspException {
        try {
            ...
            log.error("JDBC error iterating across Category", e);
			...
			if(parent != null){
				pageContext.setAttribute("tagError", true);
				pageContext.setAttribute("tagErrorException", e);
				pageContext.setAttribute("tagErrorMessage", "JDBC error iterating across Category" + stat.toString());
				return parent.doEndTag();
			}else{
				throw new JspException("JDBC error iterating across Category",e);
			}
    ...
    public int doEndTag() throws JspTagException, JspException {
        try {
            ...
            log.error("JDBC error ending Category iterator",e);
			freeConnection();
