...
public class CategoryDeleter extends N3CDashboardTagLibBodyTagSupport {
	...
	private static final Logger log = LogManager.getLogger(CategoryDeleter.class);
    ...
    public int doStartTag() throws JspException {
        ...
        try {
            ...
            log.error("JDBC error generating Category deleter", e);
			...
			if(parent != null){
				...
				pageContext.setAttribute("tagErrorMessage", "Error: JDBC error generating Category deleter");
				return parent.doEndTag();
			}else{
				throw new JspException("Error: JDBC error generating Category deleter",e);
			}
