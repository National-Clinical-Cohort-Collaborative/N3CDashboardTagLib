...
public class N3CDashboardTagLibBodyTagSupport extends BodyTagSupport {

    protected DataSource theDataSource = null;
    protected Connection theConnection = null;

    public N3CDashboardTagLibBodyTagSupport() {
        super();
    }

    private static final Logger log = LogManager.getLogger(N3CDashboardTagLibBodyTagSupport.class);
