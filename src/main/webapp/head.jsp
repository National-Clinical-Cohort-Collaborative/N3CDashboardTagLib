    <head>
        ...
        <script type="text/javascript" charset="utf8" src="sers/resources/DataTables/js/jquery.dataTables.min.js"></script>
        <style type="text/css" media="all">
        @import "/sers/resources/n3c_login_style.css";
        @import "/sers/resources/main_style.css";
        </style>
        <style type="text/css">
