...
<dashboard:tag tid="${tid}">
	<h2>Tag: <dashboard:tagTid /></h2>
		<table border=1>
			...
			<tr>
				<td><a href="edit.jsp?tid=<dashboard:tagTid />"><dashboard:tagTid /></a></td>
								...
								<dashboard:foreachDashboardTag var="didIter">
									<dashboard:dashboardTag>
										<tr>
											...
											<td><a href="../tag/tag.jsp?tid=<dashboard:dashboardTagTid />"><dashboard:dashboardTagTid /></a></td>
		...
		<a href="../tag/tag.jsp?tid=<dashboard:dashboardTagTid />"><dashboard:dashboardTagTid /></a>
